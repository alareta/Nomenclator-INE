...
if [ -n "$PID_OCUPA" ]; then
    ...
    case "$NOMBRE_PROCESO" in
        ...
        *)
            ...
            echo
            echo "Cierra ese programa, o cambia el puerto abriendo una"
            echo "Terminal y ejecutando:"
            echo "  PORT=8081 ./iniciar_mac.command"
            echo "============================================"
            echo
            read -p "Pulsa Intro para cerrar esta ventana..."
            exit 1
            ;;
    esac
fi
